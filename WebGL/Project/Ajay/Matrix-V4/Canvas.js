...
function keyDown(event) 
{
	...
	switch(event.keyCode) 
	{
		...
		case 73:
		case 105:
			//framebufferQuadYTranslate += 0.02;
			yReverseE += 0.02;
			break;	
		
		case 74:
		case 106:
			//framebufferQuadXTranslate -= 0.02;
			xReverseE -= 0.02;
			break;		
		...
		case 80:
		case 112:
			//console.log("frameXScale: " + framebufferQuadXScale);
			//console.log("frameYScale: " + framebufferQuadYScale);
			//console.log("frameXTranslate: " + framebufferQuadXTranslate);
			//console.log("frameYTranslate: " + framebufferQuadYTranslate);
			console.log("xReverseE: " + xReverseE);
			console.log("yReverseE: " + yReverseE);
			break;
