...
function paper_init()
{
	...
	Paper_texture1 = load_texture("FirstTexture-02.png");
	Paper_texture2 = load_texture("SecondTexture-01.png");
	Paper_texture3 = load_texture("ThirdTexture-02.png");
	Paper_texture4 = load_texture("ForthTexture-02.png");

	reverse_Paper_texture1 = load_texture("ReverseFirstTexture-01.png");
	reverse_Paper_texture2 = load_texture("ReverseSecondTexture-01.png");
	reverse_Paper_texture3 = load_texture("ReverseThirdTexture.png");
	reverse_Paper_texture4 = load_texture("ReverseForthTexture-01.png");
...
function paper_draw()
{
  ...
  // shader program 2
	if(scene2_rightToLeft_done == 1)
	{
		...
		{
			blast_incr_value = blast_incr_value + 0.0005;
		}	
